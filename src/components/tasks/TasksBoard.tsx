...
export function TasksBoard() {
  ...
  const filtered = useMemo(() => {
    ...
    if (fClient)
      list = list.filter((t) => t.clientName?.toLowerCase().includes(fClient.toLowerCase()));
    list.sort((a, b) =>
      fSort === "recent"
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Demandas internas, agendamentos e delegações da corretora.
      </p>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex flex-1 min-w-0 flex-wrap items-center gap-2">
            ...
            <Select value={fAssignee} onValueChange={setFAssignee}>
              <SelectTrigger className="w-full sm:w-48 rounded-xl bg-muted border-0">
            ...
            >
              <ToggleGroupItem value="alta" className="rounded-lg h-9 text-xs">
                Alta
              </ToggleGroupItem>
              <ToggleGroupItem value="media" className="rounded-lg h-9 text-xs">
                Média
              </ToggleGroupItem>
              <ToggleGroupItem value="baixa" className="rounded-lg h-9 text-xs">
                Baixa
              </ToggleGroupItem>
            </ToggleGroup>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 ml-auto">
            ...
            <Button variant="outline" className="rounded-xl" onClick={() => setManageOpen(true)}>
              ...
              <span className="hidden md:inline">Gerenciar etapas</span>
            </Button>
            <Button
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirmDelete
                ? `"${confirmDelete.title}" será removida. Esta ação não pode ser desfeita.`
                : ""}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
